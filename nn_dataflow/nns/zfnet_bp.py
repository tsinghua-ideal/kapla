...
NN.add('fc1_back_w', FCBackWeightLayer(4096, 512, 6), prevs=('fc2_back'))
NN.add('pool3_back_w', PoolingBackLayer(512, 13, 3, strd=2), prevs=('fc1_back'))
NN.add('conv5_back_w', ConvBackWeightLayer(512, 1024, 13, 3), prevs=('pool3_back'))
NN.add('conv4_back_w', ConvBackWeightLayer(1024, 512, 13, 3), prevs=('conv5_back'))
NN.add('conv3_back_w', ConvBackWeightLayer(512, 256, 13, 3), prevs=('conv4_back'))
NN.add('pool2_back_w', PoolingBackLayer(256, 26, 3, strd=2), prevs=('conv3_back'))
NN.add('conv2_back_w', ConvBackWeightLayer(256, 96, 55, 5, 2), prevs=('pool2_back'))
NN.add('pool1_back_w', PoolingBackLayer(96, 110, 3, strd=2), prevs=('conv2_back'))
NN.add('conv1_back_w', ConvBackWeightLayer(96, 3, 224, 7, 2), prevs=('pool1_back'))