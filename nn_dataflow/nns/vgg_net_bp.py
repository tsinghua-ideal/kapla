...
NN.add('fc1_back_w', FCBackWeightLayer(4096, 512, 7), prevs=('fc2_back'))
NN.add('pool5_back_w', PoolingBackLayer(512, 14, 2), prevs=('fc1_back'))
NN.add('conv13_back_w', ConvBackWeightLayer(512, 512, 14, 3), prevs=('pool5_back'))
NN.add('conv12_back_w', ConvBackWeightLayer(512, 512, 14, 3), prevs=('conv13_back'))
NN.add('conv11_back_w', ConvBackWeightLayer(512, 512, 14, 3), prevs=('conv12_back'))
NN.add('pool4_back_w', PoolingBackLayer(512, 28, 2), prevs=('conv11_back'))
NN.add('conv10_back_w', ConvBackWeightLayer(512, 512, 28, 3), prevs=('pool4_back'))
NN.add('conv9_back_w', ConvBackWeightLayer(512, 512, 28, 3), prevs=('conv10_back'))
NN.add('conv8_back_w', ConvBackWeightLayer(512, 256, 28, 3), prevs=('conv9_back'))
NN.add('pool3_back_w', PoolingBackLayer(256, 56, 2), prevs=('conv8_back'))
NN.add('conv7_back_w', ConvBackWeightLayer(256, 256, 56, 3), prevs=('pool3_back'))
NN.add('conv6_back_w', ConvBackWeightLayer(256, 256, 56, 3), prevs=('conv7_back'))
NN.add('conv5_back_w', ConvBackWeightLayer(256, 128, 56, 3), prevs=('conv6_back'))
NN.add('pool2_back_w', PoolingBackLayer(128, 112, 2), prevs=('conv5_back'))
NN.add('conv4_back_w', ConvBackWeightLayer(128, 128, 112, 3), prevs=('pool2_back'))
NN.add('conv3_back_w', ConvBackWeightLayer(128, 64, 112, 3), prevs=('conv4_back'))
NN.add('pool1_back_w', PoolingBackLayer(64, 224, 2), prevs=('conv3_back'))
NN.add('conv2_back_w', ConvBackWeightLayer(64, 64, 224, 3), prevs=('pool1_back'))
NN.add('conv1_back_w', ConvBackWeightLayer(64, 3, 224, 3), prevs=('conv2_back'))
